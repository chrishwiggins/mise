...
alias cset "set path = ( /usr/local/bin ~//Documents/Scripts/perl ~//Documents/Scripts/osa ~//Documents/Scripts/sh/csh ~//bin /opt/local/bin /usr/local/mysql/bin $path /opt/local/libexec/gnubin    /usr/local/sbin )"
